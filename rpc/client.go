...
const (
	...
	subscribeTimeout     = 5 * time.Second  // overall timeout ice_subscribe, rpc_modules calls
)
...
// EthSubscribe registers a subscripion under the "ice" namespace.
func (c *Client) EthSubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
	return c.Subscribe(ctx, "ice", channel, args...)
}
