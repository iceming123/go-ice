...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gice.ipc", false, filepath.Join(os.TempDir(), "gice.ipc")},
		{"data", "gice.ipc", false, "data/gice.ipc"},
		{"data", "./gice.ipc", false, "./gice.ipc"},
		{"data", "/gice.ipc", false, "/gice.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gice.ipc", true, `\\.\pipe\gice.ipc`},
		{"data", "gice.ipc", true, `\\.\pipe\gice.ipc`},
		{"data", `\\.\pipe\gice.ipc`, true, `\\.\pipe\gice.ipc`},
	}
