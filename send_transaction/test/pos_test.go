...
func TestDeposit(t *testing.T) {
	...
	manager := newTestPOSManager(55, executable)
	fmt.Println(" saddr1 ", types.ToCoin(manager.GetBalance(saddr1)), " StakingAddress ", manager.GetBalance(types.StakingAddress), " ", types.ToCoin(manager.GetBalance(types.StakingAddress)))
}
