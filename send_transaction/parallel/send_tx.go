...
func loop(conn *iceclient.Client, ctx *cli.Context) {
	loopMutex.Lock()
...
func startDelegateTx(conn *iceclient.Client) {
...
func sendTransactions(client *iceclient.Client, value *big.Int) {
...
func initAccount(conn *iceclient.Client) {
...
func sendOtherContractTransaction(client *iceclient.Client, toAddress common.Address, value *big.Int, privateKey *ecdsa.PrivateKey, nonceOther uint64, wait *sync.WaitGroup) (common.Hash, error) {
	defer wait.Done()
...
func sendSonTransaction(client *iceclient.Client, from, toAddress common.Address, value *big.Int, privateKey *ecdsa.PrivateKey, input []byte, method string) (common.Hash, error) {
	blockMutex.Lock()
...
func querySendTx(conn *iceclient.Client) {
