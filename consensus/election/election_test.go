...
func makeSnail(snail *snailchain.SnailBlockChain, fastchain *core.BlockChain, parent *types.SnailBlock, n int, engine consensus.Engine, db icedb.Database, seed int) []*types.SnailBlock {
...
func makeFast(parent *types.Block, n int, engine consensus.Engine, db icedb.Database, seed int) []*types.Block {
