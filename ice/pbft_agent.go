// Copyright 2018 The Icechain Authors
// This file is part of the ice library.
//
// The ice library is free software: you can redistribute it and/or modify
...
// along with the ice library. If not, see <http://www.gnu.org/licenses/>.
...
import (
	...
	"github.com/iceming123/go-ice/utils"
	...
	"github.com/iceming123/go-ice/crypto/ecies"
...
var (
	oldReceivedMetrics       = metrics.NewRegisteredMeter("ice/pbftAgent/old", nil)
	repeatReceivedMetrics    = metrics.NewRegisteredMeter("ice/pbftAgent/repeat", nil)
	newReceivedMetrics       = metrics.NewRegisteredMeter("ice/pbftAgent/new", nil)
	differentReceivedMetrics = metrics.NewRegisteredMeter("ice/pbftAgent/different", nil)
	nodeHandleMetrics        = metrics.NewRegisteredMeter("ice/pbftAgent/handle", nil)

	tpsMetrics           = metrics.NewRegisteredMeter("ice/pbftAgent/tps", nil)
	pbftConsensusCounter = metrics.NewRegisteredCounter("ice/pbftAgent/pbftConsensus", nil)
)
...
func NewPbftAgent(ice Backend, config *params.ChainConfig, engine consensus.Engine, election *elect.Election, gasFloor, gasCeil uint64) *PbftAgent {
	agent := &PbftAgent{
		config:               config,
		engine:               engine,
		eth:                  ice,
		fastChain:            ice.BlockChain(),
		snailChain:           ice.SnailBlockChain(),
		...
		vmConfig:             vm.Config{EnablePreimageRecording: ice.Config().EnablePreimageRecording},
		gasFloor:             gasFloor,
		gasCeil:              gasCeil,
...
func (agent *PbftAgent) initNodeInfo(ice Backend) {
