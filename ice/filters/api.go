...
// `ice_getFilterChanges` polling method that is also used for log filters.
//
// https://github.com/ice/wiki/wiki/JSON-RPC#ice_newpendingtransactionfilter
...
// It is part of the filter package since polling goes with ice_getFilterChanges.
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#ice_newblockfilter
...
func (api *PublicFilterAPI) Logs(ctx context.Context, crit FilterCriteria) (*rpc.Subscription, error) {
	...
	logsSub, err := api.events.SubscribeLogs(icechain.FilterQuery(crit), matchedLogs)
	if err != nil {
		return nil, err
	}
...
type FilterCriteria icechain.FilterQuery
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#ice_newfilter
func (api *PublicFilterAPI) NewFilter(crit FilterCriteria) (rpc.ID, error) {
	logs := make(chan []*types.Log)
	logsSub, err := api.events.SubscribeLogs(icechain.FilterQuery(crit), logs)
	if err != nil {
		return rpc.ID(""), err
	}
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#ice_getlogs
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#ice_uninstallfilter
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#ice_getfilterlogs
...
//
// https://github.com/ethereum/wiki/wiki/JSON-RPC#ice_getfilterchanges
