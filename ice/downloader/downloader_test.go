...
import (
	...
	dtypes "github.com/iceming123/go-ice/ice/types"
...
type downloadTester struct {
	...
	stateDb     icedb.Database    // Database used by the tester for syncing from peers
	peerDb      icedb.Database    // Database of the peers containing all data
...
func newTester() *downloadTester {
	...
	tester.stateDb = icedb.NewMemDatabase()
