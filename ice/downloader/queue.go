...
func (q *queue) reserveHeaders(p ice.PeerConnection, count int, taskPool map[common.Hash]*types.SnailHeader, taskQueue *prque.Prque,
	pendPool map[string]*ice.FetchRequest, donePool map[common.Hash]struct{}, isNoop func(*types.SnailHeader) bool) (*ice.FetchRequest, bool, error) {
...
func (q *queue) DeliverBodies(id string, fruitsLists [][]*types.SnailBlock) (int, error) {
	...
	reconstruct := func(header *types.SnailHeader, index int, result *ice.FetchResult) error {
...
func (q *queue) deliver(id string, taskPool map[common.Hash]*types.SnailHeader, taskQueue *prque.Prque,
	...
	results int, reconstruct func(header *types.SnailHeader, index int, result *ice.FetchResult) error) (int, error) {
