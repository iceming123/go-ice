...
var ProtocolName = "ice"

// ProtocolVersions are the upported versions of the ice protocol (first is primary).
var ProtocolVersions = []uint{ice64, ice63}
...
// ice protocol message codes
const (
	// Protocol messages belonging to ice/63
	StatusMsg              = 0x00
