...
// test all variations.
func makeProvers(trie *Trie) []func(key []byte) *icedb.MemDatabase {
	var provers []func(key []byte) *icedb.MemDatabase

	// Create a direct trie based Merkle prover
	provers = append(provers, func(key []byte) *icedb.MemDatabase {
		proof := icedb.NewMemDatabase()
