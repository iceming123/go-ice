...
func makeHeaderChain(fastChain *core.BlockChain, parents []*types.SnailHeader, n int, engine consensus.Engine, db icedb.Database, seed int) []*types.SnailHeader {
...
func makeBlockChain(fastChain *core.BlockChain, parents []*types.SnailBlock, n int, engine consensus.Engine, db icedb.Database, seed int) []*types.SnailBlock {
