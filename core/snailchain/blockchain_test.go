...
// header only chain.
func newCanonical(engine consensus.Engine, n int, full bool) (icedb.Database, *SnailBlockChain, *core.BlockChain, error) {
	var (
...
/*func TestFastVsFullChains(t *testing.T) {
	...
	archiveDb := icedb.NewMemDatabase()
...
//
// https://github.com/iceming123/go-ice/pull/15941
