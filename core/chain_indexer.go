...
func NewChainIndexer(chainDb, indexDb icedb.Database, backend ChainIndexerBackend, section, confirm uint64, throttling time.Duration, kind string, light bool) *ChainIndexer {
	c := &ChainIndexer{
		chainDb:     chainDb,
		indexDb:     indexDb,
		backend:     backend,
