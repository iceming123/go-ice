...
func TestDefaultLesGenesisBlock(t *testing.T) {
	client, err := iceclient.Dial("https://rpc.icechain.com")
	if err != nil {
...
func TestSetupGenesis(t *testing.T) {
	...
	tests := []struct {
		name       string
		fn         func(icedb.Database) (*params.ChainConfig, common.Hash, common.Hash, error)
	...
	}{
		{
			...
			fn: func(db icedb.Database) (*params.ChainConfig, common.Hash, common.Hash, error) {
		...
		// 	fn: func(db icedb.Database) (*params.ChainConfig, common.Hash, error, *params.ChainConfig, common.Hash, error) {
...
func Test08(t *testing.T) {
	...
	fmt.Println("ice-addr:", addr.String())
	fmt.Println("finish")
}
...
func Test03(t *testing.T) {
	...
	fmt.Println("ice-addr:", a2.String())
	b1 := a2.Bytes()
