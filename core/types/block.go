...
// Package types contains data types related to icechain consensus.
package types
...
// Block represents an entire block in the icechain blockchain.
type Block struct {
	header       *Header
	...
	// These fields are used by package ice to track
...
// "external" block encoding. used for ice protocol, etc.
...
// DecodeRLP decodes the icechain
...
// EncodeRLP serializes b into the icechain RLP block format.
...
// SnailHeader represents a block header in the icechain.
...
// SnailBlock represents an entire snail block in the IceChain snail chain.
